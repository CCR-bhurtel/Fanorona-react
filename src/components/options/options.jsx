  ...
  render () {
    ...
    return (
      <div id="buttons" className={cssObj.Options}>
        ...
        {!started && <button className="btn waves-effect waves-light "  onClick={startGame}>Start!</button>}
        {started &&  <button className="btn waves-effect  blue" onClick={startGame} >Restart</button>}
      </div>
    )
  }
}
